...
\begin{figure}[ht!] 
  \centering
  \includegraphics[width=1.0\linewidth]{Figures/asdf.png}
  \caption{The mechanical advantage in forces}
  \label{fig:showOff}
\end{figure}
...
\begin{figure}[ht!] 
  \centering
  \includegraphics[width=1.0\linewidth]{Figures/asdfg.png}
  \caption{The mechanical advantage in forces}
  \label{fig:showOff}
\end{figure}

% The robot has to move its arms out of the way to visualize the objects.
